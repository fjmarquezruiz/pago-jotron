...
class StoreVinoRequest extends FormRequest
{
     ...
     *         An associative array of validation rules for each request field.
     */
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'vintage_year' => [
                ...
                function ($attribute, $value, $fail) use ($currentYear) {
                    if ($value && $value <= $currentYear) {
                        $fail("The {$attribute} must be greater than the current year ({$currentYear}).");
                    }
                },
            ], // Vintage year can be null, but if provided, it must be a 4-digit integer and no higher than the current year.
            'image_url' => ['nullable', 'string', 'url'], // Image URL can be null, but if provided, it must be a valid URL.
            ...
            'minimum_temperature' => ['nullable', 'numeric', 'between:-50,50'], // Minimum temperature can be null, but if provided, it must be a numeric value between -50 and 50.
            'maximum_temperature' => ['nullable', 'numeric', 'between:-50,50'], // Maximum temperature can be null, but if provided, it must be a numeric value between -50 and 50.
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'minimum_temperature.lte' => 'The minimum temperature must be less than or equal to the maximum temperature.',
            ...
            'maximum_temperature.gte' => 'The maximum temperature must be greater than or equal to the minimum temperature.',
