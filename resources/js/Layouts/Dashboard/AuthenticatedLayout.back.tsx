                    ...
                    <div className="flex h-16 justify-between">
                        ...
                        <div className="hidden sm:ms-6 sm:flex sm:items-center sm:gap-2">
                            ...
                            <Link
                                href={route("profile.edit")}
                                as="button"
                                className="inline-flex items-center gap-2 rounded-md border border-transparent bg-white p-2 text-sm font-medium leading-4 text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none dark:bg-gray-800 dark:text-gray-400 dark:hover:text-gray-300"
                            >
                                {user.name}{" "}
